...
int main()
{
	...
	while (fgets(line, 256, f))
	{
		...
		j.jogos = atoi(token);
		token = strtok(NULL, ",");
		j.minutos = atoi(token);
		token = strtok(NULL, ",");

		j.aT.cestas = atoi(token);
		token = strtok(NULL, ",");
		j.aT.arremessos = atoi(token);
		token = strtok(NULL, ",");
		j.aT.percentual = atof(token);
		token = strtok(NULL, ",");

		j.a3.cestas = atoi(token);
		token = strtok(NULL, ",");
		j.a3.arremessos = atoi(token);
		token = strtok(NULL, ",");
		j.a3.percentual = atof(token);
		token = strtok(NULL, ",");

		j.a2.cestas = atoi(token);
		token = strtok(NULL, ",");
		j.a2.arremessos = atoi(token);
		token = strtok(NULL, ",");
		j.a2.percentual = atof(token);
		token = strtok(NULL, ",");

		j.aL.cestas = atoi(token);
		token = strtok(NULL, ",");
		j.aL.arremessos = atoi(token);
		token = strtok(NULL, ",");
		j.aL.percentual = atof(token);
		token = strtok(NULL, ",");
